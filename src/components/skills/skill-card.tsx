...
export const SkillCard = (props: {
  ...
  return (
    <a
      ...
      className="bg-card border-card-border flex flex-1 flex-col items-center gap-3 overflow-hidden rounded-md border border-b-3 p-6 transition-all hover:-translate-y-1.5 hover:shadow-xl"
    >
      {!!props.iconImage && (
        <ImgAstroReact
