...
export const Polaroid = (props: {
  ...
  return (
    <TiltedCard scaleOnHover={1.2} rotateAmplitude={20}>
      <div>
        <a
          href="#"
          className={cn(
            'text-foreground relative flex overflow-hidden flex-col gap-2 rounded-sm bg-white p-3 shadow-2xl hover:rotate-0 transition-all duration-500',
            props.className
          )}
        >
