...
# Deploy Start UI Web v3 with Upsun v3.3.45

## Foreword

As part of exploring modern deployment solutions, I decided to try out Upsun, a relatively new PaaS platform built by the team behind Platform.sh.
...
For this experiment, I chose to deploy our in-house tool, [Start UI Web v3](https://start-ui.com/), a modern application starter built with React, Vite, and Node.js, which we regularly use as a foundation for front-end projects. (To learn more, you can already check out our [Start UI introduction article](start-ui)!)
...
First, you need to create an account on the [Upsun](https://upsun.com/) platform via the official console.

You can sign up using an email address or a third-party provider (GitHub, Google, etc.).

A 15-day free trial is available. During this period, you can access a single project with the following resources: 1 organization, 1 project, and 2 running environments; unlimited containers and users; and up to 4.5 CPUs, 12 GB of memory, and 20 GB of network storage running simultaneously.  
...
The official Start UI Web documentation specifies that the project requires a recent version of Node.js as well as pnpm as the package manager.  
...
If you’d like to go further, you can explore our *made-in-BearStudio* open-source libraries: [UI-State](why-did-we-create-ui-state) and [Ficus UI](ficus-ui-simple-and-composable-ui-for-react-native).