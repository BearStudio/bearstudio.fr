...
![le parcours d'une commande sur un site e-commerce](images/parcours-commande-e-commerce.png)
...
![schéma d'un userflow complexe](images/schema-user-flow-complexe-1024x995.png)
...
![Légende d'un userflow](images/legende-user-flow.png)
...
![Schéma des différentes actions sur une page produit](images/schema-action-page-produit.png)
...
Si vous vous intéressez à l’UX design, on vous conseille de lire notre [article sur la loi de proximité](/fr/blog/articles/la-loi-de-proximite).
