...
Lorsque vous souhaitez rendre du code atomique, dans un service de votre application [Spring](/fr/blog/articles/versionner-entite-jpa) par exemple, il vous suffit :
