...
import CaseStudyRoleSection from '@/components/case-study/case-study-role-section.astro';
...
<CaseStudyRoleSection title="Rôle et processus">
  ...
  >
    Notre équipe a participé à la conception de l’expérience mobile à partir de l’analyse des besoins utilisateurs. Et participe également à la structuration des parcours et réalisation de prototypes basse et haute fidélité, avec des itérations pour valider les choix de conception.
    <CaseStudyTags slot="tags" tags={["Figma", "UX/UI", "Maquettes"]} />
    <CaseStudyTeam slot="team" label="Équipe sur ce rôle" members={[
      { name: "Ivan D.", role: "Lead Designer UX/UI", href: "/fr/equipe/ivan-dalmet" },
      { name: "Daryl A.", role: "UX/UI Designer", href: "/fr/equipe/daryl-avila-bonnet" },
      { name: "Dorian D.", role: "UX/UI Designer", href: "/fr/equipe/dorian-delorme" },
    ]} />
  </CaseStudyRole>
  <CaseStudyRole
    label="Rôle"
    ...
    icon="code"
  >
    Côté technique, BearStudio a assuré la réalisation de l’application mobile connectée à l’infrastructure WordPress existante : développement React Native (Android & iOS), intégration via API REST WordPress, recherche Algolia, authentification et modèle freemium.
    <CaseStudyTags slot="tags" tags={["React Native", "WordPress API", "Algolia"]} />
    <CaseStudyTeam slot="team" label="Équipe sur ce rôle" members={[
      { name: "Lead Dev", role: "Lead Développeur Full-Stack" },
    ]} />
  </CaseStudyRole>
