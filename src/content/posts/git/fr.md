...
Si vous avez lu jusqu’ici sans vous endormir, vous savez normalement gérer votre dépôt Git local et [versionner](/fr/blog/articles/versionner-entite-jpa) votre travail sans en créer manuellement plusieurs copies aux noms compliqués.
