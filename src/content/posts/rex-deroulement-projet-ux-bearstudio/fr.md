...
D’abord, l’équipe de Stéphane Assuid (CEO de One Prepaid) nous a commandé une [charte graphique](/fr/prestations/ux-design) (guide comprenant les recommandations d’utilisation des **différents éléments graphiques** susceptibles d’apparaître sur l’ensemble des **supports de communication** d’une entreprise).
...
L’audit est une étape cruciale dans un **projet numérique**, nous y accordons une grande importance au BearStudio. C’est d’ailleurs pour cela que nous avons mis en place des [mini-audit UX gratuits](/fr/prestations/ux-design).
