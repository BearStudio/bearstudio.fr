...
tags:
  ...
  - 'design'
  - 'ux'
metaDescription: 'Découvrez comment l’IA transforme le métier de designer UX/UI : nouveaux workflows, agents IA, design augmenté et pourquoi il faut évoluer dès maintenant.'
excerpt: 'L’arrivée des agents IA bouleverse les workflows des designers UX/UI. Entre génération d’interfaces, collaboration avec le code et nouveaux outils, le métier évolue rapidement. Retour d’expérience d’un designer junior qui découvre comment l’IA devient un levier pour concevoir, prototyper et mieux collaborer avec les équipes produit et développement.'
thumbnail:
  image: 'images/thumbnail.png'
  alt: "Illustration d'un robot qui tient dans ses mains un crayon et une palette de peinture"
authors:
  - 'daryl-avila-bonnet'
---
...
![Logos outils Design IA](./images/Logo_outils_design_IA.png)
...
[![Regarder la vidéo](./images/Miniature_video_youtube.jpeg)](https://www.youtube.com/watch?v=zvKATdbUlRw)
...
![Environnement de travail](./images/Env_de_travail.jpg)
