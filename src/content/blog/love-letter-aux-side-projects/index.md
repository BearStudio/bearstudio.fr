...
**Instant promo:** au Beartudio on a un starter production ready que j'utilise pour setup quelques-uns de mes side projects: [StartUI [web]](https://www.bearstudio.fr/blog/actualites-web-numerique/start-ui).  Je te recommande vivement d'y jeter un coup d'oeil si tu aimes la stack react/typescript !
