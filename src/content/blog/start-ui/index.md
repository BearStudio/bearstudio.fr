...
... is our most advanced starter that can be used for [SEO](https://www.bearstudio.fr/blog/developpement/checklist-seo-technique) (Search Engine Optimisation), PWA (Progressive Web Application), SPA (Single Page Application), SSR (Server Side Rendering). It is web ready and will boost your project setup and your productivity while ensuring code quality.
