...
Découvrez aussi l'annotation `@MockBean` dans une [autre brève](https://www.bearstudio.fr/blog/developpement/breve-9-mock-ou-mockbean) sur la thématique du [développement back](https://www.bearstudio.fr/prestations/dev-back).
