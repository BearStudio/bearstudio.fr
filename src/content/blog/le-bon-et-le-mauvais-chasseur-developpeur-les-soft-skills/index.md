...
Selon le problème il peut-être également pertinent de faire du [peer programming](https://www.bearstudio.fr/blog/developpement/peer-programming) avec un développeur plus expérimenté.
...
Pour aller plus loin, vous pouvez consulter [cet article qui rappelle les bonnes pratiques sur les erreurs standards faites en Java](https://www.bearstudio.fr/blog/developpement/java-pour-les-debutants-parfois-pour-les-experts-aussi).
