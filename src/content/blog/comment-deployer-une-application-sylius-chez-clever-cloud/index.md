...
Par la suite il vous faudra créer un nouveau dépôt Git via la commande `git init` afin de push vers Gitlab ou Github (découvrez ici le [git de survie](https://www.bearstudio.fr/blog/developpement/git) du BS).
