...
languages:
  - 'fr'
excerpt: 'Le poids des images sont souvent responsables de la durée de chargement de votre site web. Heureusement, il existe de nombreux outils pour les améliorer !'
---

## Pourquoi optimiser les images de son site ?

Optimiser les images d’un site web, ça sert à quoi au final ? Des juniors se sont peut être déjà posés la question. La réponse est plutôt simple : **accélérer le chargement du site, et [avoir un meilleur référencement](https://www.bearstudio.fr/blog/developpement/checklist-seo-technique).**
...
Une façon d’optimiser les images d’un [site web](https://www.bearstudio.fr/blog/entrepreneuriat/arretez-de-vous-faire-avoir-par-votre-agence-digitale), c’est de les compresser. Plusieurs sites se sont spécialisés dans ce genre de service, pour différents formats.
