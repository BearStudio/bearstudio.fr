...
Rust est un langage de programmation qui commence à prendre de plus en plus de place dans le monde du développement. ([C'est le deuxième langage officiel](https://lkml.org/lkml/2021/12/6/461) du [noyau Linux](https://www.bearstudio.fr/blog/developpement/linux-logiciels-libres-et-open-source-retrouvez-votre-liberte)). Il contient des concepts qu’il est intéressant d’aborder même si on ne développe pas avec tous les jours.
