...
D’abord, l’équipe de Stéphane Assuid (CEO de One Prepaid) nous a commandé une [charte graphique](https://www.bearstudio.fr/prestations/ux-design/charte-graphique) (guide comprenant les recommandations d’utilisation des **différents éléments graphiques** susceptibles d’apparaître sur l’ensemble des **supports de communication** d’une entreprise).
...
- **Comprendre le sujet de la plateforme** et ses subtilités afin d’en saisir les différentes problématiques
- **Réaliser des interviews** avec des utilisateurs afin de révéler les **forces et faiblesses** de la plateforme et les problèmes auxquels ils font face
- Faire des **points réguliers avec les clients** et leur montrer un maximum d'éléments afin de **s’assurer qu’on avance ensemble** et dans la bonne direction
- **Formuler des recommandations** et une interprétation des mesures de l’**analyse fonctionnelle**
...
L’audit est une étape cruciale dans un **projet numérique**, nous y accordons une grande importance au BearStudio. C’est d’ailleurs pour cela que nous avons mis en place des [mini-audit UX gratuits](https://www.bearstudio.fr/demandez-votre-mini-audit-ux-gratuit).

## 2) Le plan d’action UX de notre équipe
...
Revenons à nos moutons (_enfin nos ours_) : dans la lignée de l’**inventaire numérique** effectué en amont, notre **équipe UX** s’est focalisée sur la **[création des nouveaux userflows](https://www.bearstudio.fr/blog/design-css/parcours-utilisateur-ux)**.  
...
C’est une phase indispensable avant d’effectuer la **modélisation sous la forme de [wireframes](https://www.bearstudio.fr/prestations/ux-design/wireframes)**, où les problématiques de style n'entrent pas encore précisément en jeu.  
...
## 3) Les spécificités de ce projet
